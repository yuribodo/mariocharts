...
2. [AI agents](https://mariocharts.com/docs/ai-agents.md) — installable skill, chart selection, and complete chart and dashboard examples
3. [Components](https://mariocharts.com/docs/components.md) — all 12 charts
4. [llms.txt](https://mariocharts.com/llms.txt) — agent-oriented index
5. [llms-full.txt](https://mariocharts.com/llms-full.txt) — full props reference
