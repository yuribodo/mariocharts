...
export const metadata: Metadata = {
  title: "Funnel Chart",
  description:
    "Production-ready funnel chart component for React. Visualize conversion pipelines with five layouts and growing geometry. Shows percentages, values, and conversion rates. Copy-paste ready.",
  keywords: [
    "funnel chart",
    "react funnel",
    "conversion funnel",
  ...
  openGraph: {
    ...
    description:
      "Production-ready funnel chart for React with five layouts and conversion rates.",
