...
The subsequent [LineChart v1](line-chart-v1.md) records its implementation and validation. [AreaChart retirement](area-chart-v1.md) records the subsequent decision to remove the standalone component and use LineChart fills. Work on the other nine chart families remains pending.
